...
//         // Wait for a short delay to ensure the menu is loaded
//         setTimeout(function() {
//             // Find the <div> with class "wp-menu-name" containing the text "Plugins"
//             var menuDiv = $("div.wp-menu-name:contains(\'Plugins\')");
            
//             if (menuDiv.length > 0) {
//                 // Find the <span> element with class "update-plugins" inside the menuDiv
//                 var updatePlugins = menuDiv.find(".update-plugins");
                
//                 if (updatePlugins.length > 0) {
//                     // Find the <span> element with class "plugin-count" inside updatePlugins
//                     var pluginCount = updatePlugins.find(".plugin-count");
                    
//                     if (pluginCount.length > 0) {
//                         // Get the current count as an integer
//                         var currentCount = parseInt(pluginCount.text());
                        
//                         // Update the count by adding 1
//                         var newCount = currentCount + 1;
                        
//                         // Set the updated count back into the element
//                         pluginCount.text(newCount);
//                     }
//                 }
//             }
...
// </script>';
            ...
            add_action('after_plugin_row', 'display_update_notice', 10, 2); // Changed from 3 to 2
        }
    }
}
